...
# url = "https://www.fast2sms.com/dev/bulkV2"
# 	querystring = {"authorization":"LP7Uow41RrEDMGd23JbQBih0Fgt8xvqyXV59eYWnuSNOlZTaCcVxsu231aYhPSJtD0L5iWgRZojKAFrG","variables_values":"5599","route":"otp","numbers": mobileNumber}
# 	headers = {'cache-control': "no-cache"}
# 	response = requests.request("GET", url, headers=headers, params=querystring)
# 	print(response.text)